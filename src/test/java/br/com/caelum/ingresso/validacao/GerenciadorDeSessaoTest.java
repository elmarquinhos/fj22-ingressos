...
public class GerenciadorDeSessaoTest {
	...
	@Test
	public void garanteQueNãoDevePermitirSessaoTerminandoDentroDoHorarioDeUmaSessaoJaExistente(){
		Filme filme = new Filme("Rogue One", Duration.ofMinutes(120), "SCI-FI", BigDecimal.ONE);
		LocalTime horario = LocalTime.parse("10:00:00");
		Sala sala = new Sala("", BigDecimal.ONE);
	...
	@Test
	public void garanteQueNãoDevePermitirSessaoIniciandoDentroDoHorarioDeUmaSessaoJaExistente(){
		Filme filme = new Filme("Rogue One", Duration.ofMinutes(120), "SCI-FI", BigDecimal.ONE);
		LocalTime horario = LocalTime.parse("10:00:00");
		Sala sala = new Sala("", BigDecimal.ONE);
	...
	public void oPrecoDaSessaoDeveSerIgualASomaDoPrecoDaSalaMaisOPrecoDoFilme(){
		Sala sala = new Sala("Eldorado", new BigDecimal("23.5"));
